$path = "C:\Genie\GenieWeb\wwwroot\tutorials\github-copilot-for-dotnet.json"
...
$checks = [ordered]@{
  "1 writing C# w/Copilot" = "ghost text"
  "2 NUnit test gen      " = "NUnit"
  "3 refactoring/quality " = "refactor"
  "4 documentation       " = "XML documentation"
  "5 service classes     " = "service class"
